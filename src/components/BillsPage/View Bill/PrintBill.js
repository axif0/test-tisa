            ...
            <div style={{ position: 'absolute', left: '-9999px', top: 0, width: '210mm' }}>
                <div ref={billRef} style={{ 
                    ...
                    <div style={{
                        ...
                        fontSize: '60px', color: 'rgba(128,128,128,0.10)',
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style={{ verticalAlign: 'middle', textAlign: 'center', padding: 0 }}>
                                    <div style={{ color: '#2c3e50', fontSize: '28px', fontWeight: 'bold', letterSpacing: '0.5px', marginBottom: '6px' }}>TISHA PLASTIC PRODUCTS</div>
                                    <div style={{ color: '#7f8c8d', fontSize: '13px', lineHeight: '1.4' }}>
                    ...
                    <div style={{ backgroundColor: '#3498db', color: 'white', padding: '8px', textAlign: 'center', marginBottom: '15px' }}>
                        <div style={{ margin: 0, fontSize: '18px', fontWeight: 'bold' }}>BILL</div>
                    </div>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px' }}>
                        ...
                        <thead>
                            <tr style={{ backgroundColor: '#3498db', color: 'white' }}>
                                ...
                                <th style={thStyle}>মালের নাম</th>
                                <th style={{ ...thStyle, textAlign: 'right' }}>দাম</th>
                                <th style={{ ...thStyle, textAlign: 'center' }}>পরিমান</th>
                        ...
                        <tbody>
                            {items.map((item, i) => (
                                <tr key={i}>
                                    <td style={{ ...tdStyle, textAlign: 'center' }}>{englishToBengali(i + 1)}</td>
                                    <td style={tdStyle}>{item.product?.name || item.name || ''}</td>
                                    <td style={{ ...tdStyle, textAlign: 'right' }}>৳{englishToBengali(item.price)}</td>
                                    <td style={{ ...tdStyle, textAlign: 'center' }}>{englishToBengali(item.quantity)}</td>
                                    <td style={{ ...tdStyle, textAlign: 'right' }}>৳{englishToBengali(item.subTotal)}</td>
                                </tr>
                            ))}
                        </tbody>
                        <tfoot>
                            <tr style={{ backgroundColor: '#f8f9fa' }}>
                                <td colSpan="4" style={{ ...tdStyle, textAlign: 'right', fontWeight: 'bold' }}>Total Amount:</td>
                                <td style={{ ...tdStyle, textAlign: 'right', fontWeight: 'bold' }}>৳{englishToBengali(bill?.total || 0)}</td>
                            </tr>
                        </tfoot>
                    </table>
                    ...
                    <div style={{ textAlign: 'center', marginTop: '30px', color: '#7f8c8d', fontSize: '12px' }}>
